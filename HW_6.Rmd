...
- Health insurance:  health insurance type may not have a strong association with cannabis use in the individual, but the results show some relation that are surprising.
